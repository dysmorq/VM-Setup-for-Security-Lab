...
**Prerequisites**
 ...
 - At least 20 GB free disk. I kept the allocated disk at 20 GB due to the space available on disk C.
 - VirtualBox.
 - Ubuntu v24.04 LTS ISO image.

**Stage 1 — Base System Setup**

I began by doing a system prep and system updates to make sure the base OS isn't outdated.
...
I also carried the installation of the following foundational tools, using this **command: sudo apt install -y vim net-tools curl wget git htop ufw**
 ...
 - curl — A command‑line tool used to fetch files from the internet.
 ...
 - htop — An interactive process viewer that’s more user‑friendly. It shows CPU, memory, and process usage in real time, with colour coding and easy navigation.
...
In this stage I “gave my VM a sense of what’s going on around it”, giving the VM awareness and visibility. 
...
The following are the tools that I installed for this stage:
 - tcpdump — Packet capture for traffic inspection that captures packets. It enables me see the actual traffic moving through the interfaces.
 - nmap — Port scanning tool that scans ports and services to display what ports are open and reachable.
